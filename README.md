...
Python CLI tool that scores password strength and checks if a password has appeared in known data breaches — without ever sending the actual password over the network.
...
## Example password №1: password123
screenshots/weak_password.png

## Example password №2: neWpaSsWord!
screenshots/moderate_password.png

## Example password №3: 8uR?E3;x7<ztl4c7
screenshots/strong_password.png
